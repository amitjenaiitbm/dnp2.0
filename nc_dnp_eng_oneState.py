...
def create_second_page(pdf):
    ...
    # Burden text: Title - @AC change to burden of
...
def create_third_page(pdf):
    ...
    pdf.set_xy(10, 144)
    pdf.cell(50, 5, "Points of discussion:", align='L')
    #@AC early from timely space before com
    ...
    #@AC change hhs with to hhs using improved sanitattion
